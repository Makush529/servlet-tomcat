...
public class MinskTimeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        ZonedDateTime beijingTime = ZonedDateTime.now(ZoneId.of("Europe/Minsk"));
        ...
        writer.write("</head>\n");
        writer.write("<body>\n");
        writer.write("    <h1>Текущее время в <span id=\"city\"> Минске </span>: <span id=\"time\">" + formattedTime + "</span></h1>\n");
        writer.write("</body>\n");
        writer.write("</html>\n");
        writer.close();
